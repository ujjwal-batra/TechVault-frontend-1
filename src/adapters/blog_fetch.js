  ...
  function fetchMoreListItems() {
    ...
    try {
      ...
      // scrolled post request
        ...
        var details;
        if (prevLink === "http://3.142.242.194:8080/search/keyword/")
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      if (
        ...
        link = "http://3.142.242.194:8080/home/" + fromSiblings.selevtedNav;
        post_req = false;
        setPostReq(false);
        setLoadNo(1);
      } else if (
        ...
        link = "http://3.142.242.194:8080/search/company/";
        post_req = true;
        setPostReq(true);
        setLoadNo(1);
      } else if (
        ...
        link = "http://3.142.242.194:8080/search/keyword/";
        post_req = true;
        setPostReq(true);
        setLoadNo(1);
      } else {
      ...
      // initial post request
        ...
        setPrevLink(link);
        var details;
        if (link === "http://3.142.242.194:8080/search/keyword/")
          details = { searchWords: fromSiblings.passedTopics };
        else details = { searchWords: fromSiblings.passedCompany };
        postBlogRequest(details, link);
      }
